	...
	public void defaultValues() {
		...
		switch (currency) {	
		    case "Indian Rupee":
				...
				this.exchangeValues.put("CNY", 0.099);
				this.exchangeValues.put("JPY", 1.53);			
				break;
		    	
			case "US Dollar":
				this.exchangeValues.put("INR", 70.98);
				this.exchangeValues.put("USD", 1.00);
				this.exchangeValues.put("EUR", 0.93);
				this.exchangeValues.put("GBP", 0.66);
				this.exchangeValues.put("CHF", 1.01);
				this.exchangeValues.put("CNY", 7.00);
				this.exchangeValues.put("JPY", 123.54);			
				break;
			case "Euro":
				this.exchangeValues.put("INR", 78.57);
				...
				break;
			case "British Pound":
				this.exchangeValues.put("INR", 91.37);
				...
				break;
			case "Swiss Franc":
				this.exchangeValues.put("INR", 71.50);
			...
			case "Chinese Yuan Renminbi":
				this.exchangeValues.put("INR", 10.15);
				...
				break;
			case "Japanese Yen":
				this.exchangeValues.put("INR", 0.65);
